    ...
    try:
        ...
        with make_app(tree.config).test_request_context():
            ...
            try:
                ...
                for chunk in bulk_chunks(chain.from_iterable(index_file(tree, tree_indexers,path, es, index) for path in paths), docs_per_chunk=50000, bytes_per_chunk=500000):
